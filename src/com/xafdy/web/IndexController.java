...
public class IndexController {
	...
	public ModelAndView searchMyDoc() {
		ModelAndView mav = new ModelAndView();
		mav.addObject("user", indexService.getUserById(1));
	...
	public ModelAndView saveUserSchedule(UserSchedule userSchedule) {
		userSchedule.setUserId(1); 
	...
	public ModelAndView searchUserSchedule() {
		ModelAndView mav = new ModelAndView();
		mav.addObject("userSchedules", indexService.getUserSchedules(1));
